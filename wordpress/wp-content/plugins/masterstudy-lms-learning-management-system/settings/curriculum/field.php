...
wp_enqueue_script('stm-lms-curriculum', STM_LMS_URL . '/settings/curriculum/js/curriculum.js');
wp_enqueue_script('stm-lms-curriculum-add-item', STM_LMS_URL . '/settings/curriculum/js/add_item.js');
wp_enqueue_script('stm-lms-curriculum-search', STM_LMS_URL . '/settings/curriculum/js/search.js');
